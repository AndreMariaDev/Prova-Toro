...
namespace App.Infra.Migrations
{
    ...
    [Migration("20210506130135_Add-Column-UserType")]
    partial class AddColumnUserType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Models.BankAccountHistory", b =>
                {
                    b.Property<Guid>("Code")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("App.Domain.Models.BankAccountHistory", b =>
                {
                    b.HasOne("App.Domain.Models.BankAccount", "BankAccount")
                        .WithMany("ListBankAccountHistories")
            ...
            modelBuilder.Entity("App.Domain.Models.BankAccount", b =>
                {
                    b.Navigation("ListBankAccountHistories");
                });
